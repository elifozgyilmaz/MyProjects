...
namespace CourseApp304.Data.Concrete
{
    public class EfCourseRepository : ICourseRepository
    {
        ...
        public IEnumerable<Course> GetCourseByFilters(string name = null, decimal? price = null, string isActive = null,string instructor =null)
        {
            ...
            if(instructor!=null)
            {
                query = query.Where(x => x.Instructor.Name == instructor);
            }
            return query.ToList();
        }
        ...
        public void UpdateCourse(Course updateCourse, Course originalCourse = null)
        {
            ...
            Console.WriteLine($"Course Entity State:{entry.State}");
            ...
            Console.WriteLine($"Instructor Entity State:{entry1.State}");
            ...
            Console.WriteLine($"Contact Entity State:{entry2.State}");
            ...
            Console.WriteLine($"Address Entity State:{entry3.State}");
