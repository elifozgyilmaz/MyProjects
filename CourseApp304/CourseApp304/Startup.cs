...
namespace CourseApp304
{
    public class Startup
    {
        ...
        {
            services.AddMvc();//Projeye MVC olarak kullanıcağımı deklare ediyorum.
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, DataContext dataContext, UserContext userContext)
        {
            ...
            //wwwroot==>Tarayıcı tarafından ulaşılması gereken css,js ve image gibi dosyalı toplu halde barındıran ve core yapısının dışarı açılan kapısıdır.
