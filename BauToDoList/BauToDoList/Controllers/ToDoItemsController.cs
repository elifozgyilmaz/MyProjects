...
namespace BauToDoList.Controllers
{
    public class ToDoItemsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Title,Discription,Status,CategoryId,Attachment,DepartmentId,SideId,CustomerId,ManagerId,OrganizatorId,MeetingDate,PlanetDate,FinishDate,ReviseDate,ConversationSubject,SupporterCompany,SupporterDoctor,ConversionAttendeeCount,ScheduledOrganizationDate,MailingSubjects,PosterSubject,PosterCount,Elearning,TypesOfScans,AsoCountInScans,TypesOfOrganization,AsoCountInOrganization,TypesOfVaccinationOrganization,AsoCountInVaccinationOrganization,AmountOfCompensationForPoster,CorporateProductivityReport,CreatedBy,CreateDate,UpdateDate,UpdatedBy")] ToDoItem toDoItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Title,Discription,Status,CategoryId,Attachment,DepartmentId,SideId,CustomerId,ManagerId,OrganizatorId,MeetingDate,PlanetDate,FinishDate,ReviseDate,ConversationSubject,SupporterCompany,SupporterDoctor,ConversionAttendeeCount,ScheduledOrganizationDate,MailingSubjects,PosterSubject,PosterCount,Elearning,TypesOfScans,AsoCountInScans,TypesOfOrganization,AsoCountInOrganization,TypesOfVaccinationOrganization,AsoCountInVaccinationOrganization,AmountOfCompensationForPoster,CorporateProductivityReport,CreatedBy,CreateDate,UpdateDate,UpdatedBy")] ToDoItem toDoItem)
        {
            if (ModelState.IsValid)
            {
