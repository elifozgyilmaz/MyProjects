...
namespace BauToDoList.Controllers
{
    public class SidesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Name,CreatedBy,CreateDate,UpdateDate,UpdatedBy")] Side side)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Name,CreatedBy,CreateDate,UpdateDate,UpdatedBy")] Side side)
        {
            if (ModelState.IsValid)
            {
